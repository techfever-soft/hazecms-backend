    ...
    finalizeInstall(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const newAppInstance = {
                ...
                config: {
                    adminsList: req.body.database.adminsList,
                },
            };
            ...
            const mySQLService = new mysql_service_1.MySQLService(newAppInstance.database.host, newAppInstance.database.username, newAppInstance.database.password, newAppInstance.database.port);
            const databaseName = newAppInstance.database.database;
            /**
             * ANCHOR Step one: Create app instance
             */
            axios_1.default.post(config_1.baseAPIUrl + "app/createAppInstance", newAppInstance).then(() => {
            ...
            try {
                ...
                yield mySQLInstallService.useDatabase(databaseName);
                yield mySQLInstallService.createAdminTable();
                newAppInstance.config.adminsList.forEach((admin) => __awaiter(this, void 0, void 0, function* () {
                    console.log(admin);
                    yield mySQLService.insertAdmin();
                }));
                /**
